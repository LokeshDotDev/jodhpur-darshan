-- CreateEnum
CREATE TYPE "Category" AS ENUM ('Landmarks', 'Lakes', 'Markets', 'Savours', 'Temples', 'Arts', 'Museum', 'Hotels');
...
-- AddForeignKey
ALTER TABLE "Vault" ADD CONSTRAINT "Vault_postId_fkey" FOREIGN KEY ("postId") REFERENCES "Post"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
